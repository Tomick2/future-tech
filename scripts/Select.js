...
class Select extends BaseComponent {
  ...
  updateTabIndexes(isMatchDevise = MatchMedia.mobile.matches) {
    this.originalControlElement.tabIndex = isMatchDevise ? 0 : -1
    this.buttonElement.tabIndex = isMatchDevise ? -1 : 0
  }
